...
export default function ResourcesPage() {
  ...
  // All resources (fetched from API)
    ...
    fetch('/api/admin/resources')
      ...
      .then(data => {
        if (Array.isArray(data)) {
          // Map each resource to have a proper icon
          // This includes the built-in lucide-react icons or fallback to BookOpen
          ...
          setAllResources(data.map((r: any) => ({ ...r, icon: iconMap[r.iconName] || BookOpen })));
        }
      })
      .catch(() => {});
  }, []);
